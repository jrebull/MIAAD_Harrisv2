...
All data, code, and scripts are available at \url{https://github.com/jrebull/MIAAD_Harrisv2} (tag \texttt{micai-submission-v2}); with fixed seeds (diagnostic suite: 1; comparisons: 1--30) the scripts regenerate every reported number.
