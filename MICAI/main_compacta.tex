...
Data, code, and scripts are available at \url{https://github.com/jrebull/MIAAD_Harrisv2} (tag \texttt{micai-submission-v2}); with fixed seeds (diagnostic suite: 1; comparisons: 1--30) the scripts regenerate every reported number.
% >>> REVIEW: remove the URL above for double-blind submission.

\subsubsection*{Acknowledgments.}
% >>> REVIEW: omit this block for double-blind submission.
The authors thank the Universidad Aut\'onoma de Ciudad Ju\'arez.
