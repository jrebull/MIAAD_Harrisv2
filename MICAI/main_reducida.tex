...
The data, optimizer, Taguchi design, and all scripts are available at \url{https://github.com/jrebull/MIAAD_Harrisv2}; fixed seeds (diagnostic suite: 1; comparisons: 1--30) regenerate every reported number deterministically.
