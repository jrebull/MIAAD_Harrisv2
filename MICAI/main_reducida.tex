...
The problem data, the optimizer, the Taguchi design, and the scripts that reproduce every figure and table are available at \url{https://github.com/jrebull/MIAAD_Harrisv2}. A fast verifier re-runs the unit tests, claim firewall, page-count check, and ZIP identity scan. All randomized studies use fixed seeds (diagnostic suite: seed 1; 30-run comparisons: seeds 1--30), so the scripts regenerate every reported number deterministically.
