...
\node[font=\tiny\itshape, text=black!60, below=17pt of dec.south] (blocklbl)
...
\caption{The controlled $2\times2$: each cell sits at its operator's measured order-preservation $\tau$ (slightly negative for the HHO moves) and its realized population movement, annotated with mean hypervolume, gap to blind random restart (\HV\ $310{,}214$), and $A_{12}$. Only the cell meeting both conditions (circle) beats blind sampling.}
\label{fig:mech2x2}
\end{figure}
