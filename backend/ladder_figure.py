...
data = [np.array(st["nsga2_hv"]) / 1e6,
        ...
        np.array(lv5["methods"]["competent_mohho"]["hv_per_seed"]) / 1e6,
...
labels = ["NSGA-II\n(real-coded)", "MOHHO\n(real-coded)", "rk-NSGA-II\n(biased unif.)",
          "Random\nrestart", "Competent\nMO-HHO",
          "perm-\nMOEA/D", "Discrete-\nMOHHO", "perm-\nSPEA2", "perm-\nNSGA-II"]
cols = ["#E67E22", "#E8B04B", "#D68910", "#9AA3AF", "#C0903D",
        "#16A085", "#2E86DE", "#1F618D", "#27AE60"]
...
ax.set_xticks(range(1, 10)); ax.set_xticklabels(labels, fontsize=6.8)
...
lo = ax.get_ylim()[0]
ax.text(3.0, lo, "random-key encoding", ha="center", va="bottom", fontsize=7.5, color="#9C5410")
ax.text(7.5, lo, "permutation-native (4 paradigms)", ha="center", va="bottom", fontsize=7.5, color="#1B5E9C")
